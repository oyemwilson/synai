...
const Client = () => {
    ...
    return (
        <>
            <div className="container mx-auto lg:px-20 py-20 md:py-20">
                <div className="flex flex-col md:flex-row gap-0">
                    <div className="w-full md:w-1/2">
                        <div className="bg-gray-200 p-6 rounded-lg relative">
                            <img src="../../assets/images/ecommerce.png" alt="A description of my image" className="relative z-10 w-full" />
                            <img
                                src="../../assets/images/ecommernce2.png"
                                ref={smallImageRef}
                                className="h-[35%] border rounded-xl absolute bottom-0 left-[-50px] z-20 transition-all duration-100 hidden lg:block"
                                alt="A description of my image"
                            />
                        </div>
                    </div>
                    <div className="w-full md:w-1/2 p-4 bg-white flex md:justify-end">
                        <div>
                            <p className='bg-green-100 inline-block text-green-500'>E-COMMERCE</p>
                            <h1 className='text-5xl mt-5'><span className='underline decoration-green-500'>Increase sales </span><br /> and manage orders</h1>
