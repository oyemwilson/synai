...
export const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('Signup successful! Please check your email for verification code.');
      // You can redirect to OTP verification page or stay here and show OTP input
    } catch (error) {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join SynAI and start your investment journey
          </p>
        </div>
